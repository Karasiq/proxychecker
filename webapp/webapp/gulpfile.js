...
gulp.task('copy', ['bower'], function() {
    ...
    gulp.src(['../target/scala-2.11/proxychecker-webapp-opt.js', '../target/scala-2.11/proxychecker-webapp-launcher.js', '../target/scala-2.11/proxychecker-webapp-opt.js.map'])
...
gulp.task('watch', ['compile'], function() {
    gulp.watch('../target/scala-2.11/proxychecker-webapp-opt.js', ['copy']);
